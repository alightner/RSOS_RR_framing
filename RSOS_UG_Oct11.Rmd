...
**[CAN WE COMPARE SURVEY ATTRITION RATES IN PILOT VS FINAL?]**

We retained the other exploratory measures noted in the Methods. Nonetheless, these measures included standard and fair currency fees, broker fees, service charge fees, and ATM fees, expected payoffs, demographic data, emotional responses to the game, experience with currency exchange transactions, and whether or not the participant recognized the task as a bargaining game from previous experience. We outline these results, with an experimental GAMLSS analysis of our treatment distributions, for the interested reader in the experimental supplementary materials. 
