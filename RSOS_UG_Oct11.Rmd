...
We retained the other exploratory measures noted in the Methods. 

**I think we should report two or three basic analyses here (with details in the supplement), e.g., did expected payoffs influence reject decisions? did previous experience with the UG influence offers or acceptances? Where emotional responses predicted by offers (for responders) and acceptances (for proposers)?**
